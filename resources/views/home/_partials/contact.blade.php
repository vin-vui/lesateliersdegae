            ...
            <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                ...
                <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
                    ...
                    <div class="flex gap-x-4" data-aos="fade-right" data-aos-duration="1500">
                        ...
                        <dd><a class="hover:text-gray-900" href="mailto:bonjour@lesateliersdegae.fr">bonjour@lesateliersdegae.fr</a></dd>
                    </div>
                </dl>
                    ...
                    <div class="flex flex-col gap-x-8 gap-y-6">
                        <div data-aos="fade-right" data-aos-duration="1500">
                            <div class="flex justify-between text-sm leading-6">
                                <label for="name" class="ml-3 block text-sm font-semibold leading-6 text-gray-900">Prénom Nom / Pseudonyme</label>
                                <span id="company-description" class="text-gray-400">Optionel</span>
                            </div>
                            <div class="mt-2.5">
                        ...
                        <div class="sm:col-span-2" data-aos="fade-right" data-aos-duration="1500">
                            <div class="flex justify-between text-sm leading-6">
                                ...
                                <span id="company-description" class="text-red-400">Requis</span>
                            </div>
                            <div class="mt-2.5">
                                <input required id="email" name="email" type="email" autocomplete="email" class="block w-full rounded-full border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-zomp sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-2" data-aos="fade-right" data-aos-duration="1500">
                            <div class="flex justify-between text-sm leading-6">
                        ...
                        <div class="sm:col-span-2" data-aos="fade-right" data-aos-duration="1500">
                            <div class="flex justify-between text-sm leading-6">
                                ...
                                <span id="phone-description" class="text-gray-400">Optionel</span>
                            </div>
                            <div class="mt-2.5">
                        ...
                        <div class="sm:col-span-2" data-aos="fade-right" data-aos-duration="1500">
                            ...
                            <div class="mt-2.5">
                                <textarea required id="message" name="message" rows="4" aria-describedby="message-description" class="block w-full rounded-3xl border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-zomp sm:text-sm sm:leading-6"></textarea>
                            </div>
                        </div>
                        <div class="sm:col-span-2" data-aos="fade-right" data-aos-duration="1500">
                            <div class="flex bg-white rounded-3xl p-2">
                                <input required id="consent" name="consent" type="checkbox" class="h-4 w-4 mt-0.5 rounded border-gray-300 text-zomp focus:ring-zomp">
                                <label for="consent" class="ml-3 block text-sm leading-6 text-gray-900">
                                    J'accepte explicitement et consens au traitement de mes données personnelles dans le but spécifique de traiter ma demande de contact.
                                </label>
                            </div>
                        </div>
                    </div>
