<div class="overflow-hidden sm:py-24">
    ...
    <div class="mx-auto max-w-7xl px-6">
        <div class="text-center mb-12">
            <p class="text-base font-semibold leading-7 text-zomp">Qu'est-ce qu'un</p>
            <h2 class="text-3xl font-bold tracking-tight text-eccru sm:text-4xl font-amita">Mandala - Dessin Centré ?</h2>
        </div>
    ...
    <div class="mx-auto max-w-5xl px-6 mt-24">
        <h3 class="text-xl font-bold tracking-tight text-zomp sm:text-3xl text-center font-amita mt-12">Alors n'hésitez pas, offrez vous une pause <span class="font-amita font-semibold text-caribbean">mandala</span> !</h3>
        <div class="flex flex-col gap-y-4 text-center md:flex-row md:items-center justify-around mt-12">
            <a href="" class="bg-zomp hover:bg-zomp/80 text-white rounded-full font-semibold py-4 px-6 flex items-center gap-2">
            ...
            <a href="" class="bg-caribbean hover:bg-caribbean/80 text-white rounded-full font-semibold py-4 px-6 flex items-center gap-2">
